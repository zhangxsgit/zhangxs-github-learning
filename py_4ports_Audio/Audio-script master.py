...
headline    =    "AT Command test"
description =    "AT Command test for DSB \n using 4 COM ports"
...
def button1_script():               # is being called when UI button is pressed
    ...
    comA.write_and_check_answer("BCLK=256kHz")               #STM32 can only 32*8kHz
    comA.write_and_check_answer("master")               #master mode!!!
    comB.setRTS(True)
    comB.write_and_check_answer("ATI")
    comB.write_and_check_answer("AT^SAIC=1,\"\",\"\",\"\",1,0,1,0,0") #slave mode!!!
    comB.setRTS(True)
    comC.write_and_check_answer("ATI")
    comC.write_and_check_answer("AT^SAIC=1,\"\",\"\",\"\",1,0,1,0,0") #slave mode!!!
    comD.write_and_check_answer("DSP=off")
    comD.write_and_check_answer("BCLK=256kHz")               #STM32 can only 32*8kHz
    comD.write_and_check_answer("master")               #master mode!!!
